            ...
            <div className="grow overflow-hidden">
                <div className="p-12 flex flex-col items-center min-h-screen">
                    ...
                    <div className="w-full flex justify-center items-center relative grow">
                        <ThemeCard
                            title='Quick Start'
                            description='Get started with the quick start guide'
                        ...
                        <ThemeCard
                            title="Main Preview"
                            description="See how your presentation will look with this theme"
                        ...
                        <ThemeCard
                            ...
                            description="Discover the features of this theme"
